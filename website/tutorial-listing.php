                ...
                <?php if (!empty($nursery_students)): ?>
                    <?php foreach ($nursery_students as $row): ?>
                        ...
                        <td><?= htmlspecialchars($row['school']) ?></td>
                            ...
                            <a class="btn btn-warning btn-sm edit-btn" href="update-tutorial-form.php?student_id=<?= htmlspecialchars($row['tutorial_id']); ?>">
                                    Edit
                                </a>
                                <form action="../database/db_delete_tutorial.php" method="POST" onsubmit="return confirm('Are you sure you want to delete this student?');" class="d-inline">
                                    <input type="hidden" name="student_id" value="<?= htmlspecialchars($row['tutorial_id'], ENT_QUOTES, 'UTF-8'); ?>">
